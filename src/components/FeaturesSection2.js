    ...
    >
      <div className="container">
        ...
        <div className="FeaturesSection2__box box">
          <div className="FeaturesSection2__columns columns is-multiline is-centered is-gapless">
            {items.map((item, index) => (
              <div
                className={
                  "FeaturesSection2__column column" +
              ...
              >
                <div className="FeaturesSection2__item has-text-centered">
                  <div className="FeaturesSection2__image-container">
                    <figure className="FeaturesSection2__image image is-4by3">
